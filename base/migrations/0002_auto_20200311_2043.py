...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='banji',
            name='banji_major',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='base.Major'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
        ...
        migrations.AddField(
            model_name='user',
            name='user_banji',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='base.Banji'),
        ),
        migrations.AddField(
            model_name='user',
